...
if __name__ == '__main__':
    ...
    while True:
        ...
        mg_mask, mg_orient = cv.calcMotionGradient( motion_history, MAX_TIME_DELTA, MIN_TIME_DELTA, apertureSize=5 )
        seg_mask, seg_bounds = cv.segmentMotion(motion_history, timestamp, MAX_TIME_DELTA)
